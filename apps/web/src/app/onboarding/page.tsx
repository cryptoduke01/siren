        ...
        <div className="mt-8 flex flex-col items-center gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <SocialButton
              ...
              onClick={() => { hapticLight(); signInWithOAuth("twitter"); }}
            />
            <SocialButton
              label="Google"
              icon={
              ...
              onClick={() => { hapticLight(); signInWithOAuth("google"); }}
            />
            <SocialButton
              label="GitHub"
              icon={
              ...
              onClick={() => { hapticLight(); signInWithOAuth("github"); }}
            />
          </div>
        </div>
