            ...
            <div className="px-5 py-5">
              ...
              <div className="mt-4 grid gap-2 sm:grid-cols-2">
                ...
                <div className="rounded-2xl border p-4" style={{ borderColor: "var(--border-subtle)", background: "var(--bg-base)" }}>
                  ...
                  <p className="mt-2 font-body text-sm" style={{ color: "var(--text-2)" }}>
                    Search by <span className="font-semibold" style={{ color: "var(--text-1)" }}>market</span> or <span className="font-semibold" style={{ color: "var(--text-1)" }}>outcome</span> to route faster.
                  </p>
                </div>
              </div>
            </div>
